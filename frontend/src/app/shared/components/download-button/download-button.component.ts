  ...
  template: `
    ...
    <div *ngIf="showModal" class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
      ...
      <div class="flex min-h-full items-center justify-center p-4">
        <div class="relative bg-gray-900 border border-cyan-500/50 rounded-lg shadow-xl max-w-md w-full transform transition-all"
          ...
          <div class="px-6 py-4 border-b border-cyan-500/30" 
            ...
            <h3 class="text-lg font-semibold neon-text" id="modal-title">
          ...
          <div class="px-6 py-6">
            ...
            <div *ngIf="!isPending && !isSuccess">
              ...
              <div class="mb-4">
                <label for="email" class="block text-sm font-medium neon-text mb-2">
                  Email Address
                </label>
                <input
                  type="email"
